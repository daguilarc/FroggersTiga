# vcv-section-expander-architecture Specification

## Purpose
Define the local-only VCV Rack module topology as named sections and optional left/right extensions, with main owning the shared engine and audio callback.
