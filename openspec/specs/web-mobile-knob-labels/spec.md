# web-mobile-knob-labels Specification

## Purpose
Ensure mobile knob grids use three columns with visible labels on every page before Play, sourced from generated host-display authority.
## Requirements
