# desktop-v2-encoder-rings Specification

## Purpose
Desktop v2 and VST v2 encoder rings render global Crunchy fuego, two concentric scene-voice value rings with a blended-center dot, modulation range arcs, and modulator/gesture badges, with bank switching when a module page has more rows than physical encoders.
## Requirements
