# pair-ar-rotated-desktop-labels Specification

## Purpose
Require fully legible 90-degree pair-AR labels on desktop Audio panels using AudioPairArLayout constants without truncation at default width.
## Requirements
