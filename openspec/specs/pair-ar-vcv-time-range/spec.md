# pair-ar-vcv-time-range Specification

## Purpose
Map pair-AR knob values to exponential time constants from 1 ms to 10 s matching VCV Fundamental ADSR display endpoints.
## Requirements
