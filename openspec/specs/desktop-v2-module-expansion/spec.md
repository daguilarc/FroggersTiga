# desktop-v2-module-expansion Specification

## Purpose
On v2 hosts, the Random, Reverb, Filter, Drive, and Delay module pages expand from seven to ten encoder rows (two new parameter rows plus Crispy), with new row labels sourced from `V2ParamDisplayNames` and a parallel Comb/Peak filter topology; Audio and ADSR are excluded from this row expansion.
## Requirements
