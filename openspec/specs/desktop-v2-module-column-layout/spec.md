# desktop-v2-module-column-layout Specification

## Purpose
Desktop v2 carousel module pages, parameter-detail grids, and the fixed 16-step sequencer region share one `DesktopV2ChromeLayout` authority and avoid overlap or default-size scrolling at 1280x920.
