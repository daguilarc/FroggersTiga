# web-v2-parameter-subset Specification

## Purpose
The web/WASM host adopts the desktop-v2 engine and UI parameter expansion (new FX module rows, global Crunchy) while explicitly excluding desktop v2 chrome — encoder rings, scenes, gestures, shift, sequencer, ADSR page, and the v2 mod-source grid — keeping v1's page-pill/rotary-knob/four-cell-mod-bay interaction model.
## Requirements
