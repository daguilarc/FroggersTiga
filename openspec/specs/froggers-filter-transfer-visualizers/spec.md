# froggers-filter-transfer-visualizers Specification

## Purpose
ResonantBump and Comb expose Sheaf's `DspTransferFunction` interface; a Sheaf-idiomatic visualizer plots their frequency response as a dimmed-behind-the-knob underlay, consistent with other parameter visualizers.
