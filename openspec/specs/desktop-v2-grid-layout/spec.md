...
## Purpose
`DesktopV2ChromeLayout.hpp` defines manifest-era layout constants, one top chrome stack with transport/signal and global-command bands, compact module grids, and fixed 16-step sequencer region geometry.
