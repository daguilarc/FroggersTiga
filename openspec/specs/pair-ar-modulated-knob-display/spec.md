# pair-ar-modulated-knob-display Specification

## Purpose
Require pair-AR rotaries on desktop and web to display live effective values when mod depth is active, matching vertical page-row behavior.
## Requirements
