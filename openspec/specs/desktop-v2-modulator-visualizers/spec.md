# desktop-v2-modulator-visualizers Specification

## Purpose
Shared fifteen-lane CV history for the global oscilloscope projection and detail-grid encoder activity underlays.
