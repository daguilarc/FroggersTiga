...
Today:
  ...
  ┌─ vcv/ (GPL, local-only) ────────────────────────────────────────┐
  │ v2.4.0: minimal gray SVG panels + silkscreen labels (ParamDisplayNames) │
  │ Voicing 48 HP + FX 36 HP + Primary 24 HP; mod rack green LED only │
  │ VST/desktop unchanged — JUCE UI with scopes                         │
  └─────────────────────────────────────────────────────────────────┘
