...
On sim hosts, Audio row 8 (Crispy / FUEG) SHALL remain the fuegoizer and external-mix topology control; it SHALL NOT be the primary PM3 depth control when `SetSimDedicatedPm3Knob(true)`.
